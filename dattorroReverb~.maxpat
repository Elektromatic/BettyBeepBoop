...
,
					"patching_rect" : [ 297.0, 497.0, 192.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 245.0, 425.0, 192.0, 20.0 ],
					"text" : "Taken from Max gen~ examples"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 210.0, 216.0, 71.0, 22.0 ],
					"text" : "predelay $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 210.0, 186.0, 99.0, 22.0 ],
					"text" : "r #1_predelay"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 210.0, 151.0, 71.0, 22.0 ],
					"text" : "damping $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 210.0, 121.0, 99.0, 22.0 ],
					"text" : "r #1_damping"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 100.0, 216.0, 57.0, 22.0 ],
					"text" : "decay $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 100.0, 186.0, 85.0, 22.0 ],
					"text" : "r #1_decay"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 68.0, 84.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 84.0, 151.0, 61.0, 22.0 ],
					"text" : "drywet $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 84.0, 121.0, 89.0, 22.0 ],
					"text" : "r #1_drywet"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 199.0, 357.0, 30.0, 30.0 ]
				}
...
,
					"patching_rect" : [ 68.0, 323.0, 150.0, 23.0 ],
					"text" : "gen~"
				}
